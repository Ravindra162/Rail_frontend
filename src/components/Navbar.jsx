...
const Navbar = () => {
  ...
  return (
    <div className='h-16 w-full bg-slate-100 flex justify-between gap-0 items-center'>
     ...
     <button className='transition ease-in-out delay-400 text-black mx-10 w-36 h-12 hover:bg-[#167CD8] hover:text-white rounded-xl'>Search Trains</button>
     <button className='transition ease-in-out delay-400 text-black mx-10 w-36 h-12 hover:bg-[#167CD8] hover:text-white rounded-xl'>Book Ticket</button>
     ...
     className=''>{name?'Logout':'Login'}</button>
        </DropdownItem>
      </DropdownMenu>
    </Dropdown>
    </button>
